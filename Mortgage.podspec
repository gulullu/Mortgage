...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/gulullu/ios_calculator.git", :tag => "1.0.0" }      #项目地址，这里不支持ssh的地址，验证不通过，只支持HTTP和HTTPS，最好使用HTTPS
  ...
  s.resources = "Mortgage/Mortgage/MortgageVc/*.{xib},Mortgage/Mortgage/MortgageVc/*.{xib}"                               #资源文件地址
